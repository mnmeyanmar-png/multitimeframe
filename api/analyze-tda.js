export default async function handler(request, response) {
    ...
    try {
        ...
        const systemPrompt = "သင်သည် အလွန်ကျွမ်းကျင်သော market structure trader တစ်ဦးဖြစ်ပြီး Top-Down Analysis (TDA) ကို အထူးပြုပါသည်။ သင်၏ခွဲခြမ်းစိတ်ဖြာမှုသည် professional traders အပေါ် အခြေခံသည်။ မြန်မာဘာသာဖြင့်သာ တိကျရှင်းလင်းစွာ တုံ့ပြန်ပါ။";
